      ...
      <header className="w-full p-6 sm:px-10 flex flex-col sm:flex-row justify-between items-center gap-6 animate-in fade-in duration-700">
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          <button 
            ...
            className="flex-1 sm:flex-none bg-[#5549ED] hover:bg-[#4338CA] border border-white/20 px-4 sm:px-8 py-3 rounded-full text-[8px] sm:text-[10px] font-black uppercase tracking-[1px] sm:tracking-[2.5px] transition-all flex items-center justify-center gap-2 shadow-xl active:scale-95"
          >
            <span className="text-xs sm:text-sm">🏆</span> CONQUISTAS
          </button>
          <button 
            onClick={handleLogout}
            className="flex-1 sm:flex-none bg-white/10 hover:bg-white/20 border border-white/10 px-4 sm:px-8 py-3 rounded-full text-[8px] sm:text-[10px] font-black uppercase tracking-[1px] sm:tracking-[2.5px] transition-all active:scale-95 shadow-md"
          >
            SAIR
          </button>
        </div>
