            ...
            <div className="grid grid-cols-3 md:grid-cols-3 gap-3 sm:gap-6">
              ...
              <button onClick={onOpenBulk} className={cardBaseClass}>
                ...
                <div className="flex-1">
                  ...
                  <p className="hidden sm:block text-sm text-slate-400 font-medium leading-relaxed px-2">Vincule fotos aos cartões existentes usando o campo 'Desc Imagem'.</p>
                </div>
              </button>
              ...
              <div className={`${cardBaseClass} cursor-pointer`}>
                ...
                <div className="flex-1">
                  ...
                  <p className="hidden sm:block text-sm text-slate-400 font-medium leading-relaxed px-2">Carregue sua base de dados de cartões via arquivo Excel ou CSV.</p>
                </div>
              </div>
