...
const ImportModal: React.FC<ImportModalProps> = ({ db, user, onClose, currentCount, onOpenBulk }) => {
      ...
      <div className="bg-white w-full max-w-6xl rounded-[40px] shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in duration-300">
        <div className="p-6 sm:p-10 border-b flex justify-between items-center bg-indigo-600 text-white rounded-t-[40px]">
          <div>
            ...
            <p className="text-white/60 font-bold text-[10px] sm:text-xs uppercase tracking-widest mt-1">Gerencie a entrada de novos dados</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <button onClick={onOpenBulk} className={cardBaseClass}>
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-black text-slate-800 mb-2">Upload de Fotos</h4>
                  <p className="text-sm text-slate-400 font-medium leading-relaxed px-2">Vincule fotos às latas existentes usando o campo 'Desc Imagem'.</p>
                </div>
              </button>
              ...
              <div className={`${cardBaseClass} cursor-pointer`}>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-400 font-medium leading-relaxed px-2">Carregue sua base de dados completa via arquivo Excel ou CSV.</p>
                </div>
              </div>
              ...
              <button onClick={downloadTemplate} className={cardBaseClass}>
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-black text-slate-800 mb-2">Baixar Template</h4>
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 text-center">
                  ...
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Campos Incompletos</p>
                </div>
              </div>
                    ...
                    {fileData.slice(0, 8).map((row, i) => {
                      ...
                      return (
                        <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4 text-slate-600 font-bold">{row.size || '-'}</td>
                        </tr>
                      );
                    })}
                  </tbody>
